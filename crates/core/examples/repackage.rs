...
//! Run: WIIU_COMMON_KEY=<32hex or key file> cargo run -p wiiuvci-core --release --example repackage -- <staged_dir> <out> <cert_path> <title_id_hex>
mod common;

use std::path::Path;
use wiiuvci_core::package::cert::CertChain;
use wiiuvci_core::package::{PackageParams, build_package};
